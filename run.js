...
function buildGame() {
    ...
    code += `<script src="/dist/main.js"></script>\n`;
    code += `<script src="/dist/joystick-helper.js"></script>\n`;
    code += `<script src="/dist/gui-helper.js"></script>\n`;
    ...
    try {
        ...
        esbuild.buildSync({
            ...
            keepNames: true,
            logLevel: "silent",
            entryPoints: ["code/gui-helper.ts"],
            outfile: "dist/gui-helper.js",
        ...
        esbuild.buildSync({
            ...
            keepNames: true,
            logLevel: "silent",
            entryPoints: ["code/joystick-helper.ts"],
            outfile: "dist/joystick-helper.js",
